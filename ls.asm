...
fmtname(char *path)
{
  ...
  9a:	05 74 0e 00 00       	add    $0xe74,%eax
  ...
  return buf;
  ae:	b8 74 0e 00 00       	mov    $0xe74,%eax
}
...
ls(char *path)
{
  ...
  e3:	68 6f 0b 00 00       	push   $0xb6f
  e8:	6a 02                	push   $0x2
  ea:	e8 ca 06 00 00       	call   7b9 <printf>
 ...
 116:	68 83 0b 00 00       	push   $0xb83
 11b:	6a 02                	push   $0x2
 11d:	e8 97 06 00 00       	call   7b9 <printf>
 ...
 177:	53                   	push   %ebx
 178:	50                   	push   %eax
 179:	68 97 0b 00 00       	push   $0xb97
 17e:	6a 01                	push   $0x1
 180:	e8 34 06 00 00       	call   7b9 <printf>
 ...
 1a8:	68 a4 0b 00 00       	push   $0xba4
 1ad:	6a 01                	push   $0x1
 1af:	e8 05 06 00 00       	call   7b9 <printf>
 ...
 25b:	50                   	push   %eax
 25c:	68 83 0b 00 00       	push   $0xb83
 261:	6a 01                	push   $0x1
 263:	e8 51 05 00 00       	call   7b9 <printf>
 ...
 29a:	53                   	push   %ebx
 29b:	50                   	push   %eax
 29c:	68 97 0b 00 00       	push   $0xb97
 2a1:	6a 01                	push   $0x1
 2a3:	e8 11 05 00 00       	call   7b9 <printf>
...
000006da <chgrp>:
SYSCALL(chgrp)    
 6da:	b8 21 00 00 00       	mov    $0x21,%eax
 6df:	cd 40                	int    $0x40
 6e1:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 6eb:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
 6ee:	83 ec 04             	sub    $0x4,%esp
 6f1:	6a 01                	push   $0x1
 6f3:	8d 45 f4             	lea    -0xc(%ebp),%eax
 6f6:	50                   	push   %eax
 6f7:	ff 75 08             	pushl  0x8(%ebp)
 6fa:	e8 03 ff ff ff       	call   602 <write>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 70c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
 713:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
 717:	74 17                	je     730 <printint+0x2b>
 719:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 71d:	79 11                	jns    730 <printint+0x2b>
    neg = 1;
 71f:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
 726:	8b 45 0c             	mov    0xc(%ebp),%eax
 729:	f7 d8                	neg    %eax
 72b:	89 45 ec             	mov    %eax,-0x14(%ebp)
 72e:	eb 06                	jmp    736 <printint+0x31>
  } else {
    x = xx;
 ...
 733:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  i = 0;
 736:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 73d:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 740:	8d 41 01             	lea    0x1(%ecx),%eax
 743:	89 45 f4             	mov    %eax,-0xc(%ebp)
 746:	8b 5d 10             	mov    0x10(%ebp),%ebx
 749:	8b 45 ec             	mov    -0x14(%ebp),%eax
 74c:	ba 00 00 00 00       	mov    $0x0,%edx
 751:	f7 f3                	div    %ebx
 753:	89 d0                	mov    %edx,%eax
 755:	0f b6 80 60 0e 00 00 	movzbl 0xe60(%eax),%eax
 75c:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 760:	8b 5d 10             	mov    0x10(%ebp),%ebx
 763:	8b 45 ec             	mov    -0x14(%ebp),%eax
 766:	ba 00 00 00 00       	mov    $0x0,%edx
 76b:	f7 f3                	div    %ebx
 76d:	89 45 ec             	mov    %eax,-0x14(%ebp)
 770:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 774:	75 c7                	jne    73d <printint+0x38>
  if(neg)
 776:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 77a:	74 2d                	je     7a9 <printint+0xa4>
    buf[i++] = '-';
 77c:	8b 45 f4             	mov    -0xc(%ebp),%eax
 77f:	8d 50 01             	lea    0x1(%eax),%edx
 782:	89 55 f4             	mov    %edx,-0xc(%ebp)
 785:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 78a:	eb 1d                	jmp    7a9 <printint+0xa4>
    putc(fd, buf[i]);
 78c:	8d 55 dc             	lea    -0x24(%ebp),%edx
 ...
 7a1:	e8 3c ff ff ff       	call   6e2 <putc>
 7a6:	83 c4 10             	add    $0x10,%esp
  ...
  while(--i >= 0)
 7a9:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
 7ad:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 7b1:	79 d9                	jns    78c <printint+0x87>
    putc(fd, buf[i]);
}
 7b3:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 7bc:	83 ec 28             	sub    $0x28,%esp
  ...
  state = 0;
 7bf:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
 7c6:	8d 45 0c             	lea    0xc(%ebp),%eax
 7c9:	83 c0 04             	add    $0x4,%eax
 7cc:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
 7cf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 7d6:	e9 59 01 00 00       	jmp    934 <printf+0x17b>
    c = fmt[i] & 0xff;
 ...
 7e9:	25 ff 00 00 00       	and    $0xff,%eax
 7ee:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
 7f1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
 7f5:	75 2c                	jne    823 <printf+0x6a>
      if(c == '%'){
 7f7:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 7fb:	75 0c                	jne    809 <printf+0x50>
        state = '%';
 7fd:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
 804:	e9 27 01 00 00       	jmp    930 <printf+0x177>
      } else {
        putc(fd, c);
 ...
 816:	e8 c7 fe ff ff       	call   6e2 <putc>
 81b:	83 c4 10             	add    $0x10,%esp
 81e:	e9 0d 01 00 00       	jmp    930 <printf+0x177>
      }
    } else if(state == '%'){
 823:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 827:	0f 85 03 01 00 00    	jne    930 <printf+0x177>
      if(c == 'd'){
 82d:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 831:	75 1e                	jne    851 <printf+0x98>
        printint(fd, *ap, 10, 1);
 ...
 840:	e8 c0 fe ff ff       	call   705 <printint>
 845:	83 c4 10             	add    $0x10,%esp
        ap++;
 848:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 84c:	e9 d8 00 00 00       	jmp    929 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
 851:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 855:	74 06                	je     85d <printf+0xa4>
 857:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 85b:	75 1e                	jne    87b <printf+0xc2>
        printint(fd, *ap, 16, 0);
 ...
 86a:	e8 96 fe ff ff       	call   705 <printint>
 86f:	83 c4 10             	add    $0x10,%esp
        ap++;
 872:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 876:	e9 ae 00 00 00       	jmp    929 <printf+0x170>
      } else if(c == 's'){
 87b:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 87f:	75 43                	jne    8c4 <printf+0x10b>
        s = (char*)*ap;
 ...
 891:	75 25                	jne    8b8 <printf+0xff>
          s = "(null)";
 893:	c7 45 f4 b9 0b 00 00 	movl   $0xbb9,-0xc(%ebp)
        while(*s != 0){
 89a:	eb 1c                	jmp    8b8 <printf+0xff>
          putc(fd, *s);
 ...
 8ac:	e8 31 fe ff ff       	call   6e2 <putc>
 8b1:	83 c4 10             	add    $0x10,%esp
          s++;
 8b4:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 8bb:	0f b6 00             	movzbl (%eax),%eax
 8be:	84 c0                	test   %al,%al
 8c0:	75 da                	jne    89c <printf+0xe3>
 8c2:	eb 65                	jmp    929 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 8c4:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 8c8:	75 1d                	jne    8e7 <printf+0x12e>
        putc(fd, *ap);
 ...
 8d9:	e8 04 fe ff ff       	call   6e2 <putc>
 8de:	83 c4 10             	add    $0x10,%esp
        ap++;
 8e1:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 8e5:	eb 42                	jmp    929 <printf+0x170>
      } else if(c == '%'){
 8e7:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 8eb:	75 17                	jne    904 <printf+0x14b>
        putc(fd, c);
 ...
 8fa:	e8 e3 fd ff ff       	call   6e2 <putc>
 8ff:	83 c4 10             	add    $0x10,%esp
 902:	eb 25                	jmp    929 <printf+0x170>
      } else {
 ...
 90c:	e8 d1 fd ff ff       	call   6e2 <putc>
 ...
 921:	e8 bc fd ff ff       	call   6e2 <putc>
 926:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
 929:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 930:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 934:	8b 55 0c             	mov    0xc(%ebp),%edx
 937:	8b 45 f0             	mov    -0x10(%ebp),%eax
 93a:	01 d0                	add    %edx,%eax
 93c:	0f b6 00             	movzbl (%eax),%eax
 93f:	84 c0                	test   %al,%al
 941:	0f 85 94 fe ff ff    	jne    7db <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 9f7:	75 20                	jne    a19 <free+0xcf>
    p->s.size += bp->s.size;
 9f9:	8b 45 fc             	mov    -0x4(%ebp),%eax
 9fc:	8b 50 04             	mov    0x4(%eax),%edx
 ...
 a17:	eb 08                	jmp    a21 <free+0xd7>
  } else
    p->s.ptr = bp;
 a19:	8b 45 fc             	mov    -0x4(%ebp),%eax
 a1c:	8b 55 f8             	mov    -0x8(%ebp),%edx
 a1f:	89 10                	mov    %edx,(%eax)
  freep = p;
 a21:	8b 45 fc             	mov    -0x4(%ebp),%eax
 a24:	a3 8c 0e 00 00       	mov    %eax,0xe8c
}
 a29:	90                   	nop
 a2a:	c9                   	leave  
 a2b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a7c:	50                   	push   %eax
 a7d:	e8 c8 fe ff ff       	call   94a <free>
 a82:	83 c4 10             	add    $0x10,%esp
  return freep;
 a85:	a1 8c 0e 00 00       	mov    0xe8c,%eax
}
 a8a:	c9                   	leave  
 a8b:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a95:	83 c0 07             	add    $0x7,%eax
 a98:	c1 e8 03             	shr    $0x3,%eax
 a9b:	83 c0 01             	add    $0x1,%eax
 a9e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 aa1:	a1 8c 0e 00 00       	mov    0xe8c,%eax
 aa6:	89 45 f0             	mov    %eax,-0x10(%ebp)
 aa9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 aad:	75 23                	jne    ad2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 aaf:	c7 45 f0 84 0e 00 00 	movl   $0xe84,-0x10(%ebp)
 ab6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 ab9:	a3 8c 0e 00 00       	mov    %eax,0xe8c
 abe:	a1 8c 0e 00 00       	mov    0xe8c,%eax
 ac3:	a3 84 0e 00 00       	mov    %eax,0xe84
    base.s.size = 0;
 ac8:	c7 05 88 0e 00 00 00 	movl   $0x0,0xe88
 acf:	00 00 00 
  }
 ...
 b16:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
 b19:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b1c:	8b 55 ec             	mov    -0x14(%ebp),%edx
 b1f:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
 b22:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b25:	a3 8c 0e 00 00       	mov    %eax,0xe8c
      return (void*)(p + 1);
 b2a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 b2d:	83 c0 08             	add    $0x8,%eax
 b30:	eb 3b                	jmp    b6d <malloc+0xe1>
    }
    if(p == freep)
 b32:	a1 8c 0e 00 00       	mov    0xe8c,%eax
 b37:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 b3a:	75 1e                	jne    b5a <malloc+0xce>
      if((p = morecore(nunits)) == 0)
 b3c:	83 ec 0c             	sub    $0xc,%esp
 b3f:	ff 75 ec             	pushl  -0x14(%ebp)
 b42:	e8 e5 fe ff ff       	call   a2c <morecore>
 b47:	83 c4 10             	add    $0x10,%esp
 b4a:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b4d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b51:	75 07                	jne    b5a <malloc+0xce>
        return 0;
 b53:	b8 00 00 00 00       	mov    $0x0,%eax
 b58:	eb 13                	jmp    b6d <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 b68:	e9 6d ff ff ff       	jmp    ada <malloc+0x4e>
}
 b6d:	c9                   	leave  
 b6e:	c3                   	ret    
