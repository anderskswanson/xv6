...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      6b:	50                   	push   %eax
      6c:	68 af 14 00 00       	push   $0x14af
      71:	6a 02                	push   $0x2
      73:	e8 79 10 00 00       	call   10f1 <printf>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      be:	50                   	push   %eax
      bf:	68 bf 14 00 00       	push   $0x14bf
      c4:	6a 02                	push   $0x2
      c6:	e8 26 10 00 00       	call   10f1 <printf>
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 cf 14 00 00       	push   $0x14cf
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 ec 14 00 00       	push   $0x14ec
     259:	6a 02                	push   $0x2
     25b:	e8 91 0e 00 00       	call   10f1 <printf>
     ...
     2c7:	eb 1b                	jmp    2e4 <main+0x44>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 ef 14 00 00       	push   $0x14ef
...
// add support for built-ins here. cd is a built-in
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     341:	50                   	push   %eax
     342:	68 f7 14 00 00       	push   $0x14f7
     347:	6a 02                	push   $0x2
     349:	e8 a3 0d 00 00       	call   10f1 <printf>
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 05 15 00 00       	push   $0x1505
     3ad:	6a 02                	push   $0x2
     3af:	e8 3d 0d 00 00       	call   10f1 <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 09 15 00 00       	push   $0x1509
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 cf 0f 00 00       	call   13c4 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 99 0f 00 00       	call   13c4 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 36 0f 00 00       	call   13c4 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 ee 0e 00 00       	call   13c4 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 a6 0e 00 00       	call   13c4 <malloc>
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 24 1a 00 00       	push   $0x1a24
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 24 1a 00 00       	push   $0x1a24
     ...
     63c:	50                   	push   %eax
     63d:	68 2c 1a 00 00       	push   $0x1a2c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 24 1a 00 00       	push   $0x1a24
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 24 1a 00 00       	push   $0x1a24
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 0e 15 00 00       	push   $0x150e
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 0f 15 00 00       	push   $0x150f
     772:	6a 02                	push   $0x2
     774:	e8 78 09 00 00       	call   10f1 <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 1e 15 00 00       	push   $0x151e
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 25 15 00 00       	push   $0x1525
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 27 15 00 00       	push   $0x1527
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 29 15 00 00       	push   $0x1529
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 2b 15 00 00       	push   $0x152b
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 48 15 00 00       	push   $0x1548
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 4b 15 00 00       	push   $0x154b
    ...
    panic("parseblock");
     ...
     9c4:	68 4d 15 00 00       	push   $0x154d
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 58 15 00 00       	push   $0x1558
    ...
    panic("syntax - missing )");
     ...
     a14:	68 5a 15 00 00       	push   $0x155a
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 4b 15 00 00       	push   $0x154b
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 1e 15 00 00       	push   $0x151e
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 6d 15 00 00       	push   $0x156d
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 7b 15 00 00       	push   $0x157b
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 80 15 00 00 	mov    0x1580(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
0000100a <chown>:
SYSCALL(chown)
    100a:	b8 20 00 00 00       	mov    $0x20,%eax
    100f:	cd 40                	int    $0x40
    1011:	c3                   	ret    

00001012 <chgrp>:
SYSCALL(chgrp)    
    1012:	b8 21 00 00 00       	mov    $0x21,%eax
    1017:	cd 40                	int    $0x40
    1019:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    1020:	8b 45 0c             	mov    0xc(%ebp),%eax
    1023:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    ...
    1032:	e8 03 ff ff ff       	call   f3a <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    104f:	74 17                	je     1068 <printint+0x2b>
    1051:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    1055:	79 11                	jns    1068 <printint+0x2b>
    neg = 1;
    ...
    1066:	eb 06                	jmp    106e <printint+0x31>
  } else {
    x = xx;
  ...
  do{
    ...
    108d:	0f b6 80 34 1a 00 00 	movzbl 0x1a34(%eax),%eax
    1094:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    1098:	8b 5d 10             	mov    0x10(%ebp),%ebx
    ...
    10ac:	75 c7                	jne    1075 <printint+0x38>
  if(neg)
    10ae:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10b2:	74 2d                	je     10e1 <printint+0xa4>
    buf[i++] = '-';
  ...
  while(--i >= 0)
    10c2:	eb 1d                	jmp    10e1 <printint+0xa4>
    putc(fd, buf[i]);
    10c4:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    10d9:	e8 3c ff ff ff       	call   101a <putc>
  ...
  while(--i >= 0)
    10e1:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    10e5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    10e9:	79 d9                	jns    10c4 <printint+0x87>
    putc(fd, buf[i]);
}
    10eb:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    110e:	e9 59 01 00 00       	jmp    126c <printf+0x17b>
    c = fmt[i] & 0xff;
    ...
    113c:	e9 27 01 00 00       	jmp    1268 <printf+0x177>
      } else {
        putc(fd, c);
    ...
    114e:	e8 c7 fe ff ff       	call   101a <putc>
    1153:	83 c4 10             	add    $0x10,%esp
    1156:	e9 0d 01 00 00       	jmp    1268 <printf+0x177>
      }
    } else if(state == '%'){
    115b:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    115f:	0f 85 03 01 00 00    	jne    1268 <printf+0x177>
      if(c == 'd'){
    1165:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1169:	75 1e                	jne    1189 <printf+0x98>
        printint(fd, *ap, 10, 1);
    ...
    1178:	e8 c0 fe ff ff       	call   103d <printint>
    117d:	83 c4 10             	add    $0x10,%esp
        ap++;
    1180:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1184:	e9 d8 00 00 00       	jmp    1261 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    1189:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    118d:	74 06                	je     1195 <printf+0xa4>
    118f:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    1193:	75 1e                	jne    11b3 <printf+0xc2>
        printint(fd, *ap, 16, 0);
    1195:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1198:	8b 00                	mov    (%eax),%eax
    119a:	6a 00                	push   $0x0
    119c:	6a 10                	push   $0x10
    119e:	50                   	push   %eax
    119f:	ff 75 08             	pushl  0x8(%ebp)
    11a2:	e8 96 fe ff ff       	call   103d <printint>
    11a7:	83 c4 10             	add    $0x10,%esp
        ap++;
    11aa:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11ae:	e9 ae 00 00 00       	jmp    1261 <printf+0x170>
      } else if(c == 's'){
    11b3:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    11b7:	75 43                	jne    11fc <printf+0x10b>
        s = (char*)*ap;
    11b9:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11bc:	8b 00                	mov    (%eax),%eax
    11be:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    11c1:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    11c5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    11c9:	75 25                	jne    11f0 <printf+0xff>
          s = "(null)";
    11cb:	c7 45 f4 98 15 00 00 	movl   $0x1598,-0xc(%ebp)
        while(*s != 0){
    11d2:	eb 1c                	jmp    11f0 <printf+0xff>
          putc(fd, *s);
    ...
    11e4:	e8 31 fe ff ff       	call   101a <putc>
    11e9:	83 c4 10             	add    $0x10,%esp
          s++;
    11ec:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    11f8:	75 da                	jne    11d4 <printf+0xe3>
    11fa:	eb 65                	jmp    1261 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    11fc:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1200:	75 1d                	jne    121f <printf+0x12e>
        putc(fd, *ap);
    1202:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1205:	8b 00                	mov    (%eax),%eax
    1207:	0f be c0             	movsbl %al,%eax
    120a:	83 ec 08             	sub    $0x8,%esp
    120d:	50                   	push   %eax
    120e:	ff 75 08             	pushl  0x8(%ebp)
    1211:	e8 04 fe ff ff       	call   101a <putc>
    1216:	83 c4 10             	add    $0x10,%esp
        ap++;
    1219:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    121d:	eb 42                	jmp    1261 <printf+0x170>
      } else if(c == '%'){
    121f:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1223:	75 17                	jne    123c <printf+0x14b>
        putc(fd, c);
    ...
    1232:	e8 e3 fd ff ff       	call   101a <putc>
    1237:	83 c4 10             	add    $0x10,%esp
    123a:	eb 25                	jmp    1261 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    123c:	83 ec 08             	sub    $0x8,%esp
    123f:	6a 25                	push   $0x25
    1241:	ff 75 08             	pushl  0x8(%ebp)
    1244:	e8 d1 fd ff ff       	call   101a <putc>
    ...
    1259:	e8 bc fd ff ff       	call   101a <putc>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    126c:	8b 55 0c             	mov    0xc(%ebp),%edx
    126f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1272:	01 d0                	add    %edx,%eax
    1274:	0f b6 00             	movzbl (%eax),%eax
    1277:	84 c0                	test   %al,%al
    1279:	0f 85 94 fe ff ff    	jne    1113 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  freep = p;
    ...
    135c:	a3 cc 1a 00 00       	mov    %eax,0x1acc
}
    1361:	90                   	nop
    1362:	c9                   	leave  
    1363:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    1367:	83 ec 18             	sub    $0x18,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    136a:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    1371:	77 07                	ja     137a <morecore+0x16>
    nu = 4096;
    1373:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    137a:	8b 45 08             	mov    0x8(%ebp),%eax
    137d:	c1 e0 03             	shl    $0x3,%eax
    1380:	83 ec 0c             	sub    $0xc,%esp
    1383:	50                   	push   %eax
    1384:	e8 19 fc ff ff       	call   fa2 <sbrk>
    1389:	83 c4 10             	add    $0x10,%esp
    138c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    138f:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1393:	75 07                	jne    139c <morecore+0x38>
    return 0;
    1395:	b8 00 00 00 00       	mov    $0x0,%eax
    139a:	eb 26                	jmp    13c2 <morecore+0x5e>
  hp = (Header*)p;
    139c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    139f:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    13a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13a5:	8b 55 08             	mov    0x8(%ebp),%edx
    13a8:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    13ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13ae:	83 c0 08             	add    $0x8,%eax
    13b1:	83 ec 0c             	sub    $0xc,%esp
    13b4:	50                   	push   %eax
    13b5:	e8 c8 fe ff ff       	call   1282 <free>
    13ba:	83 c4 10             	add    $0x10,%esp
  return freep;
    13bd:	a1 cc 1a 00 00       	mov    0x1acc,%eax
}
    13c2:	c9                   	leave  
    13c3:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    144b:	c1 e0 03             	shl    $0x3,%eax
    144e:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    1451:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1454:	8b 55 ec             	mov    -0x14(%ebp),%edx
    1457:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    145a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    145d:	a3 cc 1a 00 00       	mov    %eax,0x1acc
      return (void*)(p + 1);
    1462:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1465:	83 c0 08             	add    $0x8,%eax
    1468:	eb 3b                	jmp    14a5 <malloc+0xe1>
    }
    if(p == freep)
    146a:	a1 cc 1a 00 00       	mov    0x1acc,%eax
    146f:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    1472:	75 1e                	jne    1492 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    1474:	83 ec 0c             	sub    $0xc,%esp
    1477:	ff 75 ec             	pushl  -0x14(%ebp)
    147a:	e8 e5 fe ff ff       	call   1364 <morecore>
    147f:	83 c4 10             	add    $0x10,%esp
    1482:	89 45 f4             	mov    %eax,-0xc(%ebp)
    1485:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1489:	75 07                	jne    1492 <malloc+0xce>
        return 0;
    148b:	b8 00 00 00 00       	mov    $0x0,%eax
    1490:	eb 13                	jmp    14a5 <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14a0:	e9 6d ff ff ff       	jmp    1412 <malloc+0x4e>
}
    14a5:	c9                   	leave  
    14a6:	c3                   	ret    
