...
main(int argc, char * argv[])
{
  ...
  38:	50                   	push   %eax
  39:	e8 fb 01 00 00       	call   239 <atoi>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 483:	0f b6 80 24 0b 00 00 	movzbl 0xb24(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5bf:	75 25                	jne    5e6 <printf+0xff>
          s = "(null)";
 5c1:	c7 45 f4 d0 08 00 00 	movl   $0x8d0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 687:	a1 40 0b 00 00       	mov    0xb40,%eax
...
free(void *ap)
{
 ...
 752:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 757:	90                   	nop
 758:	c9                   	leave  
 759:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7cc:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7cf:	a1 40 0b 00 00       	mov    0xb40,%eax
 7d4:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7d7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7db:	75 23                	jne    800 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7dd:	c7 45 f0 38 0b 00 00 	movl   $0xb38,-0x10(%ebp)
 7e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7e7:	a3 40 0b 00 00       	mov    %eax,0xb40
 7ec:	a1 40 0b 00 00       	mov    0xb40,%eax
 7f1:	a3 38 0b 00 00       	mov    %eax,0xb38
    base.s.size = 0;
 7f6:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 7fd:	00 00 00 
  }
 ...
 853:	a3 40 0b 00 00       	mov    %eax,0xb40
      return (void*)(p + 1);
 ...
 85e:	eb 3b                	jmp    89b <malloc+0xe1>
    ...
    if(p == freep)
 860:	a1 40 0b 00 00       	mov    0xb40,%eax
