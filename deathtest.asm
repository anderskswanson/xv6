...
deathtest(void)
{
  ...
  12:	7e 22                	jle    36 <deathtest+0x36>
    {
  ...
  29:	68 d0 07 00 00       	push   $0x7d0
  2e:	e8 57 03 00 00       	call   38a <sleep>
  33:	83 c4 10             	add    $0x10,%esp
    }
    if(pid == 0)
  36:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  3a:	75 05                	jne    41 <deathtest+0x41>
        exit();
  3c:	e8 b9 02 00 00       	call   2fa <exit>
    if(pid < 0)
  41:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  45:	79 12                	jns    59 <deathtest+0x59>
        printf(2, "FORKERROR\n");
  47:	83 ec 08             	sub    $0x8,%esp
  4a:	68 78 08 00 00       	push   $0x878
  4f:	6a 02                	push   $0x2
  51:	e8 5b 04 00 00       	call   4b1 <printf>
